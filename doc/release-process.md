...
* Update manpages, see [gen-manpages.sh](https://github.com/bluecoin-project/bluecoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
### Build and sign Bluecoin Core for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --num-make `nproc` --memory 3000 --commit bluecoin=v${VERSION} ../bluecoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --num-make `nproc` --memory 3000 --commit bluecoin=v${VERSION} ../bluecoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --num-make `nproc` --memory 3000 --commit bluecoin=v${VERSION} ../bluecoin/contrib/gitian-descriptors/gitian-osx.yml
